...
@Component({
  selector: 'app-absence-leave-popup',
  standalone: true,
  imports: [
    MatDialogModule,
    MatButtonModule,
  ...
  templateUrl: './absence-leave-popup.component.html',
  styleUrl: './absence-leave-popup.component.scss'
})
export class AbsenceLeavePopupComponent {
  @Input() fieldsToShow: string[] = []
  readonly dialogRef = inject(MatDialogRef<AbsenceLeavePopupComponent>)
